                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            {userSelectedAllCorrect ? (
                              <Badge
                                variant="outline"
                                className="bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 border-green-300 dark:border-green-700"
                              >
                              ...
                              <Badge
                                variant="outline"
                                className="bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300 border-red-300 dark:border-red-700"
                              >
                      ...
                      <div className="ml-9 sm:ml-11 space-y-4">
                        ...
                        <div className="space-y-2">
                          {question.answers.map(
                            (answer: AnswerProps, ansIdx: number) => {
                              const isSelected = userAnswerIds.includes(
                                answer.id
                              );
